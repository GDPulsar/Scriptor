...
public class Descriptors {
  ...
  public final Descriptor LONG = INSTANCE.register("long", new SimpleDurationDescriptor(Word.Cost.add(3), 5));
  public final Descriptor LONGER = INSTANCE.register("longer", new SimpleDurationDescriptor(Word.Cost.add(6), 12));
  public final Descriptor VERY_LONG = INSTANCE.register("very_long", new SimpleDurationDescriptor(Word.Cost.multiply(3), 120));
  public final Descriptor STACKING_LONG = INSTANCE.register("stacking_long", new SimpleDurationDescriptor(Word.Cost.multiply(1.2), 7).allowDuplication());
  public final Descriptor SLOW = INSTANCE.register("slow", new SpeedDurationDescriptor(Word.Cost.add(5), 4, 0.75));
  public final Descriptor FAST = INSTANCE.register("fast", new SpeedDurationDescriptor(Word.Cost.add(5), -4, 1.25));
